...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){ 
        ...
        additionalDetails.setBounds(290,80,450,55);
        ...
        religion = new JComboBox(valReligion); // for dropdown box
        ...
        category = new JComboBox(valcategory); // for dropdown box
        ...
        income = new JComboBox(incomecategory); // for dropdown box
        ...
        education = new JComboBox(educationValues); // for dropdown box
        ...
        occupation = new JComboBox(occupationalValues); // for dropdown box
        ...
        ButtonGroup SenierGroup = new ButtonGroup();
        SenierGroup.add(syes);
        SenierGroup.add(sno);
        ...
        setSize(850,800);
        setLocation(350,10);
        setVisible(true); // it is for visibility, by default it is false
